...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Computer Science, Software Engineering}{August 2021 -- Jule 2025}
    \resumeSubSubheading
      {Master of Computer Science, Data Engineering}{October 2025 -- Jule 2027}
      \resumeItem
    ...
    \begin{enumerate}
        ...
        \item Industrial Development Tools
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks}{: ASP.NET Core, Entity Framework Core, .NET, Flutter, Spring, JUnit} \\
