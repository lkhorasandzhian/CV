...
\section{Технические навыки}
  \begin{itemize}[leftmargin=0.15in,label={}]
    \small{\item{
      \resumeSkill{Фреймворки и технологии}{Spring Framework, Spring Core, Spring Boot, Spring Data, Spring MVC, Spring Web, Spring Security, AOP, JDBC, JPA, ORM, Hibernate} \\
