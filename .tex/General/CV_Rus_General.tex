...
\begin{center}
    ...
    \small Backend-разработчик \resumeSeparator{} .NET / Java \\ \vspace{1pt}
...
\section{Технические навыки}
  \begin{itemize}[leftmargin=0.15in,label={}]
    \small{\item{
      ...
      \resumeSkill{Инструменты}{Git, Docker, GitHub Actions, Linux, Postman, Swagger, Javadoc, Yandex Cloud} \\
      \resumeSkill{Тестирование}{xUnit, FluentAssertions, Testcontainers, NBomber, JUnit 5, AssertJ, Mockito}
    }}
  \end{itemize}
