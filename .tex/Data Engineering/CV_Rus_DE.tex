...
\section{Образование}
  \resumeSubHeadingListStart
    ...
    \resumeItem{
      \textbf{Релевантные курсы (GPA: 8.5/10)}: Python для инженерии данных; SQL: моделирование и управление базами данных; ETL-процессы; Распределенные базы и хранилища данных; Нереляционные базы данных; Системы хранения данных; Облачные вычисления; Инструменты промышленной разработки; Алгоритмы и структуры данных; Проектирование архитектуры программных систем
    }
